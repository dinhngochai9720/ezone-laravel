...
<head>
    <meta charset="utf-8" />
    <title>Trở thành nhà cung cấp</title>
        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Trở thành nhà cung cấp
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Bạn đã có tài khoản? <a
                                                    href="{{ route('vendor.login') }}">Đăng nhập</a></p>
                                        </div>
                                        <form id="myForm" method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="fullname" name="fullname"
                                                    value="{{ old('fullname') }}"
                                                    placeholder="Nhập tên nhà cung cấp" />
                                            </div>

                                            <div class="form-group">
                                                <input type="text" id="phone" name="phone"
                                                    value="{{ old('phone') }}" placeholder="Nhập số điện thoại" />
                                            </div>
                            ...
                            <div class="col-lg-6 pr-30 d-none d-lg-block">
                                <img class="border-radius-15 h-100"
                                    src="{{ asset('frontend/assets/imgs/page/become-vendor.png') }}" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
