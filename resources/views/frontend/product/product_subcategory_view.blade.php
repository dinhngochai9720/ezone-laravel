...
@section('main')
@section('title')
    {{ $subcategory_name['category']['category_name'] }} > {{ $subcategory_name->subcategory_name }}
@endsection
...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span></span>
            <a
                href="{{ url('product/category/' . $subcategory_name['category']['id'] . '/' . $subcategory_name['category']['category_slug']) }}">{{ $subcategory_name['category']['category_name'] }}</a>
            <span></span> {{ $subcategory_name->subcategory_name }}
        </div>
    </div>
</div>
                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                <div class="product-category">
                                    <a
                                        href="{{ url('product/subcategory/' . $product->subcategory_id . '/' . $product['subcategory']['subcategory_slug']) }}">{{ $product['subcategory']['subcategory_name'] }}</a>
                                </div>
