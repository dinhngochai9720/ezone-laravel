...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" method="POST" action="{{ route('vendor.store.product.multi_image') }}"
                        ...
                        <div class="col-lg-12">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="form-group mb-3">
                                    <label for="multiImage" class="form-label">Chọn ảnh</label>
