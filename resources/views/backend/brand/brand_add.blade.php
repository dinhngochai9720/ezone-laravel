        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm thương hiệu</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" method="POST" action="{{ route('store.brand') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Tạo thương hiệu" />
                                    </div>
                                </div>
                        </div>
                        </form>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                brand_name: {
                    required: 'Chưa nhập tên thương hiệu',
                },
                brand_image: {
                    required: 'Chưa chọn ảnh thương hiệu',
                },
            },
            errorElement: 'span',
