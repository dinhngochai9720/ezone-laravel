        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sửa banner</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" method="POST" action="{{ route('update.banner') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="banner_title" class="form-control"
                                            value="{{ $banner->banner_title }}" placeholder="Nhập tiêu đề banner" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="banner_url" class="form-control"
                                            value="{{ $banner->banner_url }}" placeholder="Nhập URL banner" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($banner->banner_image) }}" alt="banner_image"
