                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea required id="mytextarea" name="long_description"></textarea>
                                </div>


                                <div class="form-group mb-3">
                                    <label for="inputProductTitle" class="form-label">Ảnh chính</label>
                                ...
                                <div class="form-group mb-3">
                                    <label for="multiImage" class="form-label">Ảnh phụ</label>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="vendor_id" class="form-select" id="inputCollection">
                                            ...
                                            @foreach ($activeVendors as $key => $activeVendor)
                                                <option value="{{ $activeVendor->id }}">{{ $activeVendor->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="hot_deals">Ưu đãi
                                                        lớn</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input name="featured" class="form-check-input" type="checkbox"
                                                        value="1" id="featured">
                                                    <label class="form-check-label" for="featured">Sản phẩm đặc
                                                        sắc</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="special_offer">Đề nghị đặc
                                                        biệt</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="special_deals">Ưu đãi đặc
                                                        biệt</label>
                                                </div>
                                            </div>
