                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="form-group mb-3">
                                    <label for="inputProductTitle" class="form-label">Tên</label>
                                ...
                                <div class="form-group mb-3">
                                    <label for="inputProductDescription" class="form-label">Miêu tả ngắn </label>
                                    <textarea name="short_description" class="form-control" id="inputProductDescription" rows="3">{{ $product->short_description }}</textarea>
                                </div>


                                <div class="mb-3">
                                    <label for="inputProductDescription" class="form-label">Miêu tả chi tiết</label>
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="inputCollection" class="form-label">Nhà cung cấp</label>
                                        <select name="vendor_id" class="form-select" id="inputCollection">
                                            <option value="">Chọn nhà cung cấp</option>
                                            @foreach ($activeVendors as $key => $activeVendor)
                                                <option value="{{ $activeVendor->id }}"
                                                    {{ $activeVendor->id == $product->vendor_id ? 'selected' : '' }}>
                                                    {{ $activeVendor->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
...
<div class="page-content">
    ...
    <div class="card">
        <form method="POST" action="{{ route('update.product.main_image_thumbnail') }}"
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="formFile" class="form-label">Ảnh chính</label>
...
<div class="page-content">
    <div class="d-flex justify-content-between">
        <h6 class="mb-0 ">Ảnh phụ</h6>
        <div class="btn-group">
            <a href="{{ route('add.product.multi_image', $product->id) }}" class="btn btn-success">+ Thêm ảnh
                phụ</a>
        </div>
    </div>
            ...
            <table class="table mb-0 table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Cập nhật/Xóa</th>
                    </tr>
                </thead>
                <tbody>
                    <form method="POST" action="{{ route('update.product.multi_image') }}"
                        enctype="multipart/form-data">
                        @csrf
                        ...
                        @foreach ($multiImgs as $key => $img)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete.product.multi_image', $img->id) }}" class=""
                                        id="delete" title="xóa ảnh sản phẩm"><i
    ...
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                ...
                short_description: {
                    required: 'Chưa nhập miêu tả ngắn sản phẩm',
                },
                product_thumbnail: {
                    required: 'Chưa chọn ảnh chính',
                },

                selling_price: {
                    required: 'Chưa nhập giá sản phẩm',
                },

                discount_price: {
                    required: 'Chưa nhập giá sau khi giảm',
                },

                product_code: {
                    required: 'Chưa nhập code sản phẩm',
                },
                product_qty: {
                    required: 'Chưa nhập số lượng sản phẩm',
                },
                brand_id: {
                    required: 'Chưa chọn thương hiệu sản phẩm',
                },
                category_id: {
                    required: 'Chưa chọn danh mục sản phẩm',
                },
                subcategory_id: {
                    required: 'Chưa chọn danh mục con  sản phẩm',
                },

                vendor_id: {
                    required: 'Chưa chọn nhà cung cấp sản phẩm',
                },
            },
            errorElement: 'span',
