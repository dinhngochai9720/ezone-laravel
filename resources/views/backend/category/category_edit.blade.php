        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sửa danh mục</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <a href="{{ route('all.category') }}" class="btn btn-primary"><i
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="category_name" class="form-control"
                                            value="{{ $category->category_name }}" placeholder="Nhập tên danh mục" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($category->category_image) }}"
                                            alt="category_image" style="width: 100px ; height: 100px;">
                                    </div>
                                </div>
