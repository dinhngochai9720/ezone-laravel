...
@section('admin')
@section('title')
    Sửa danh mục bài viết & tin tức
@endsection
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sửa danh mục bài viết & tin tức</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="POST" action="{{ route('admin.update.blog.category') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="blog_category_name" class="form-control"
                                            ...
                                            value="{{ $blog_category->blog_category_name }}" />
                                    </div>
                                </div>
